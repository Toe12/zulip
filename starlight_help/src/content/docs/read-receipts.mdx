...
Read receipts let organization administrators and owners check who has read a
message. They can see read receipts for any message they can access, including
both [channel messages](/help/introduction-to-channels) and [direct
...
<ZulipTip>
    In addition to a list of names, you will see how many people have read the
    message.
</ZulipTip>
